...
namespace JwtAuthentication.Migrations
{
    ...
    [Migration("20190320210209_AdicionadoIconeACategoria2")]
    partial class AdicionadoIconeACategoria2
    {
            ...
            modelBuilder.Entity("JwtAuthentication.Entities.Categorias.Categoria", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 32, Grupo = 8, Icone = "simple-icon-exclamation", Nome = "Taxas Bancárias" },
                        new { Id = 33, Grupo = 8, Icone = "simple-icon-exclamation", Nome = "Cheque Especial" },
                        new { Id = 34, Grupo = 8, Icone = "simple-icon-exclamation", Nome = "Pagamento de Empréstimo" },
                        new { Id = 35, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Remuneração" },
                        new { Id = 36, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Bônus" },
                        new { Id = 37, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Rendimento" },
                        new { Id = 38, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Empréstimo" },
                        new { Id = 48, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Vale Refeição" },
                        new { Id = 39, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Outras Rendas" },
                        new { Id = 40, Grupo = 9, Icone = "simple-icon-exclamation", Nome = "Indenização - Despesa do Trabalho" },
                        new { Id = 42, Grupo = 10, Icone = "simple-icon-exclamation", Nome = "Saque" },
                        new { Id = 43, Grupo = 10, Icone = "simple-icon-exclamation", Nome = "Aplicação" },
                        new { Id = 44, Grupo = 10, Icone = "simple-icon-exclamation", Nome = "Resgate" },
                        new { Id = 45, Grupo = 10, Icone = "simple-icon-exclamation", Nome = "Transfência" },
                        new { Id = 46, Grupo = 10, Icone = "simple-icon-exclamation", Nome = "Pagamento de cartão" },
                        new { Id = 47, Grupo = 11, Icone = "simple-icon-exclamation", Nome = "Lançamento subcategorizado" }
                    );
                });
